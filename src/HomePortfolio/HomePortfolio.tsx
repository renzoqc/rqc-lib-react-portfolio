...
const HomePortfolio = ({
    ...
    return (
        <Row
            ...
            noGutter
        >
            <Col xs={18} other={13} className="content RQ-l-1">
                <p className={'RQ-f-16 RQ-theme RQ-my-1 RQ-f-code'}>{greeting}</p>
                <h1 className={'RQ-f-80 RQ-f-semi-bold RQ-f-helvetica RQ-name RQ-my-1'}>{name}</h1>
                <h2 className={'RQ-f-70 RQ-f-semi-bold RQ-f-helvetica RQ-subTitle RQ-my-1'}>{subtitle}</h2>
                <Col xs={18} other={13}>
                    <p className={'RQ-f-18 RQ-l-1_8em RQ-description RQ-f-helvetica'}>{content}</p>
                </Col>
                ...
                <Col xs={18} other={18} className={'scroll RQ-d-flex'}>
                    <a href="#AboutPortfolio" className={'RQ-d-flex RQ-justify-center RQ-align-center'}>
                        <svg className={''} width="24px" height="24px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
