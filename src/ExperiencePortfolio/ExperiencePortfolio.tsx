...
import {ExperienceList, ExperiencePortfolioProps,} from "./ExperiencePortfolio.types";
import {Col, Row} from "../Grid/Grid";
import {useState} from "react";

const ExperiencePortfolio = ({header, arrExp, className = "ExperiencePortfolio"}: ExperiencePortfolioProps) => {
