...
<Story name="ExamplePortofolio" args={{
  "headerPortfolio": {
    "logo": {
      "width": 65,
      "pathImage": "https://res.cloudinary.com/dcrzpovg4/image/upload/v1740622815/test-logo_si5euq.jpg",
      "altImage": "portfolio",
      "withText": false,
    },
    "menuHeader": {
  ...
  "projectsPortfolio": {
    ...
    "arrProjects": [
      {
        "img": {
          "source": "https://res.cloudinary.com/dcrzpovg4/image/upload/v1740626615/project-test_ycshgd.webp",
        },
        "description": {
